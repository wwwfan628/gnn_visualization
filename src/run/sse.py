...
from src.utils.train_model_sse import train_cora_reddit,train_ppi
from src.models.gcn import GCN_SSE
...
def main(args):
    ...
    gcn_baseline = GCN_SSE(in_feats, h_feats, out_feats).to(device)
